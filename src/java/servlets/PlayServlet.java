...
public class PlayServlet extends HttpServlet {
    ...
    protected void processRequest( HttpServletRequest request, HttpServletResponse response )
        ...
        // interaction panel (on the left side)
        out.write("<div class='container'>");
        getServletContext().getRequestDispatcher("/interaction.jsp").include(request, response);

        // board
        getServletContext().getRequestDispatcher("/board.jsp").include(request, response);
        out.write("</div>");
